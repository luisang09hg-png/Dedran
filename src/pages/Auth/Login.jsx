...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-on-background flex items-center justify-center p-4 starry-bg selection:bg-tertiary-fixed selection:text-on-tertiary-fixed">
      <div className="w-full max-w-md bg-surface-container-low p-8 rounded-2xl shadow-xl border border-outline-variant/30">
        <div className="text-center mb-8">
          ...
          <h1 className="text-headline-lg font-headline-lg mb-2">Bienvenido de nuevo</h1>
          <p className="text-body-md text-on-surface-variant">Ingresa a tu cuenta para continuar</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex justify-end">
            <a href="#" className="text-label-sm text-primary hover:underline">¿Olvidaste tu contraseña?</a>
          </div>
        ...
        <p className="mt-8 text-center text-label-md text-on-surface-variant">
          ¿No tienes una cuenta? <Link to="/register" className="text-primary hover:underline font-bold">Regístrate</Link>
        </p>
      </div>
    </div>
  );
